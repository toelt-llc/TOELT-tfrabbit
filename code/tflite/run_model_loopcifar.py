...
## Run TFLite 
tflite_models = []
for dirname, _, filenames in os.walk('./cifar_tflite_models/'):
...
## Run classic TF part 
cnn_model = tf.keras.models.load_model('./cifar_models/CNN_classic.h5')
ffnn_model = tf.keras.models.load_model('./cifar_models/FFNN_classic.h5')
