...
print('Interpret time 16 {}'.format(round(inf_time[0],2)))
print('Inference time 16 {}'.format(round(inf_time[1],2)))
print('Interpret time raw {}'.format(round(inf_time[0],2)))
print('Inference time raw {}'.format(round(inf_time[1],2)))
