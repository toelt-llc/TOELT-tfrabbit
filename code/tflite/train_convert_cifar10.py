...
cifar10_models_dir = pathlib.Path('./cifar10_models')
...
def CNN():
    ...
    print('Saved model : ./cifar10_models/CNN_classic.h5')
    model.save('./cifar10_models/CNN_classic.h5')
...
def FFNN():
    ...
    print('Saved model :  ./cifar10_models/FFNN_classic.h5')
    model.save('./cifar10_models/FFNN_classic.h5')
...
def convert(converter, model_name):
    ...
    # Save
    tflite_model_file = tflite_models_dir/(model_name + '_cifar10_model.tflite')
...
def convert_quant(converter, model_name):
    ...
    tflite_model_quant_file = tflite_models_dir/(model_name + '_cifar10_model_quant.tflite')
...
def convert_quant8(converter, model_name):
    ...
    tflite_model_quant8_file = tflite_models_dir/(model_name + '_cifar10_model_quant8.tflite')
...
def convert_quant16(converter, model_name):
    ...
    # Save the -default- quantized model:
    tflite_model_quant16_file = tflite_models_dir/(model_name + '_cifar10_model_quant16.tflite')
